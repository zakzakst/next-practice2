import { GetMyPostsResponse, GetMyPostsError } from "@/api/myPosts";

export const GetMyPostsResponseMock: GetMyPostsResponse = {
  posts: [
    {
      id: 1,
      title: "フロントエンドテストの例",
...
export const GetMyPostsErrorMock: GetMyPostsError = {
